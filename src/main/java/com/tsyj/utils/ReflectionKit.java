...
public final class ReflectionKit {
    ...
    public static void main(String[] args) {
        ...
        countryCode.setId(2);
        countryCode.setName("test");
        Class<?> entityClass = countryCode.getClass();
        String primaryKeyName = TableParser.getPrimaryKeyName(entityClass);
        Object idVal = mybatis.core.utils.ReflectionKit.getMethodValue(entityClass, countryCode, primaryKeyName);
